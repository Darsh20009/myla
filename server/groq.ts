...
const SUPPORT_SYSTEM_PROMPT_EN = `You are "RF" — the support assistant for Myla, a luxury perfume & oud brand.
...
${context?.role ? `\n**دور المستخدم:** ${context.role}` : ""}`
    : `You are "RF" — the smart management assistant for Myla, a luxury perfume & oud brand.
