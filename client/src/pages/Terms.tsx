...
const sections = [
  {
    ...
    title: "قبول الشروط",
    content:
      "بزيارتك أو استخدامك لمتجرنا الإلكتروني أو تطبيقنا أو أي من خدماتنا، فإنك تُقر بقراءتك وفهمك وموافقتك على الالتزام بجميع الشروط والأحكام الواردة أدناه. في حال عدم موافقتك على أي من هذه الشروط، يُرجى التوقف عن استخدام خدماتنا.",
  },
  {
    icon: AlertCircle,
    title: "تعديل الشروط",
    content:
      "نحتفظ بالحق الكامل في تعديل أو تحديث هذه الشروط والأحكام في أي وقت دون إشعار مسبق. تكون هذه التعديلات سارية المفعول فور نشرها على الموقع. يُرجى مراجعة هذه الصفحة بانتظام للاطلاع على أي تغييرات.",
  },
  {
    icon: Package,
  ...
  },
  {
    ...
    content:
      "جميع المحتويات الواردة في هذا الموقع، بما تشمل الشعارات والصور والنصوص والتصاميم، هي ملكنا الحصري محمية بموجب قوانين الملكية الفكرية. يُحظر نسخ أي محتوى أو إعادة توزيعه دون إذن كتابي مسبق.",
  },
];
        ...
        <div className="relative bg-gradient-to-br from-[#1a1a3e] via-[#6B3F2A] to-[#1a1a3e] text-white overflow-hidden">
          ...
          <div className="container relative px-4 py-16 sm:py-20 md:py-28 text-center">
            ...
            <p className="max-w-xl mx-auto text-sm sm:text-base text-white/70 font-medium leading-relaxed">
              يُرجى قراءة هذه الشروط بعناية قبل استخدام خدمات متجرنا
            </p>
          </div>
        </div>
