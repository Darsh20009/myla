      ...
      <Layout>
        <div className="min-h-screen bg-[#FFFFFF] flex items-center justify-center p-4" dir="rtl">
          <div className="max-w-sm w-full bg-white border border-gray-200 rounded-2xl p-8 text-center space-y-6 shadow-sm">
            ...
            <div>
              <h2 className="font-black text-2xl text-[#6B3F2A]">تمت العملية بنجاح!</h2>
      ...
      <Layout>
        <div className="min-h-screen bg-[#FFFFFF] flex items-center justify-center p-4" dir="rtl">
          <div className="max-w-sm w-full bg-white border border-gray-200 rounded-2xl p-8 text-center space-y-6 shadow-sm">
            ...
            <h2 className="font-black text-2xl text-[#6B3F2A]">فشلت العملية</h2>
      ...
      <div className="min-h-screen bg-[#FFFFFF]" dir="rtl">
        <div className="container max-w-md py-12 px-4 space-y-6">
          ...
          <div className="border border-purple-200 rounded-2xl p-6 text-center bg-gradient-to-br from-purple-50 to-purple-100/50">
            ...
            <div className="text-5xl font-black text-[#6B3F2A] tracking-tighter">{amount.toLocaleString()}</div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full h-14 bg-gray-50 border border-gray-200 rounded-xl text-[#6B3F2A] font-mono text-lg px-4 pr-12 text-right outline-none focus:border-purple-400 focus:ring-2 focus:ring-purple-100 transition-all"
                      dir="ltr"
                    />
            ...
            {step === "otp" && (
              <div className="space-y-6">
                <div className="text-center space-y-1">
                  ...
                  <p className="font-black text-lg text-[#6B3F2A]" dir="ltr">{phone}</p>
                ...
                <div className="flex justify-center gap-3" dir="ltr">
                  {otp.map((digit, i) => (
                    <input
                      ...
                      disabled={isLoading}
                      className={cn(
                        "w-14 h-16 text-center text-3xl font-black border rounded-xl outline-none transition-all bg-gray-50 text-[#6B3F2A]",
