...
import { Component, ReactNode, lazy, Suspense, useState } from "react";
...
function AppContent() {
  ...
  const [splashDone, setSplashDone] = useState<boolean>(() => {
    try { return sessionStorage.getItem("myla-splash-v1") === "1"; } catch { return false; }
  });

  const handleSplashFinish = () => {
    try { sessionStorage.setItem("myla-splash-v1", "1"); } catch { /* ignore */ }
    setSplashDone(true);
  };
