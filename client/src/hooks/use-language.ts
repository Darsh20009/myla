...
const translationsFull = {
  ar: {
    ...
    madeWithLove: "Myla — Abayas by HMBL",
    signIn: "تسجيل الدخول",
    ...
    brandStoryDesc: "نؤمن أن العباية ليست مجرد لباس — بل هي تعبير عن الهوية والرقي. نصمم كل تشكيلة بعشق وعناية لتعكس جمالك وأصالتك.",
    ...
    footerTagline: "Elegant abayas, comfortable cuts & fabrics you'll fall in love with",
  ...
  en: {
    ...
    brandStoryDesc: "We believe an abaya is more than a garment — it's an expression of identity and refinement. We design every collection with passion and care to reflect your beauty and authenticity.",
